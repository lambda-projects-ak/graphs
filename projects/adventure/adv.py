...
# Player moves in a random direction if available
# visited_rooms = set()
# def move_random_direction(p):
#     random_number = random.random()
#     if p.currentRoom.n_to and p.currentRoom.n_to.id not in visited_rooms and 0 < random_number < .25:
#         p.travel("n")
#         visited_rooms.add(p.currentRoom.id)
#     elif p.currentRoom.e_to and p.currentRoom.e_to.id not in visited_rooms and 0.25 < random_number < .50:
#         p.travel("e")
#         visited_rooms.add(p.currentRoom.id)
#     elif p.currentRoom.s_to and p.currentRoom.s_to.id not in visited_rooms and 0.50 < random_number < .75:
#         p.travel("s")
#         visited_rooms.add(p.currentRoom.id)
#     elif p.currentRoom.w_to and p.currentRoom.w_to.id not in visited_rooms and 0.75 < random_number < 1:
#         p.travel("w")
#         visited_rooms.add(p.currentRoom.id)
...
# Helper function to keep track of previous room
...
# starting from a room on the map
...
# use a DFS (not with a stack though) to get to a room with no unvisited exits
